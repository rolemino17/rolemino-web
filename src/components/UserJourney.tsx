    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-8 md:mb-0">
          <img src={journeyImage} alt="Journey Journey" className="rounded-lg shadow-lg border border-default" />
        </div>
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="flex items-start">
                <div className="w-8 h-8 bg-brand text-inverse rounded-full flex items-center justify-center mr-4">
                  {index + 1}
                </div>
                <div>
